...
library(knitr)
include_graphics("C:/Users/marct/OneDrive - Tecnocampus Mataro-Maresme/Documentos/CURSOS/PROJECTES/AIRBNB PRICE PREDICTION/barcelona.jpg")
```
...
include_graphics("C:/Users/marct/OneDrive - Tecnocampus Mataro-Maresme/Documentos/CURSOS/PROJECTES/AIRBNB PRICE PREDICTION/ridgeregression1.png")
```

The coefficients are those that minimize the previous formula:
```{r, warning = FALSE, message = FALSE, fig.align="center", echo = FALSE, fig.height = 5, fig.width = 10}
include_graphics("C:/Users/marct/OneDrive - Tecnocampus Mataro-Maresme/Documentos/CURSOS/PROJECTES/AIRBNB PRICE PREDICTION/ridgeregression2.png")
```
...
```{r, warning = FALSE, message = FALSE, fig.align="center", echo = FALSE, fig.height = 5, fig.width = 10}
include_graphics("C:/Users/marct/OneDrive - Tecnocampus Mataro-Maresme/Documentos/CURSOS/PROJECTES/AIRBNB PRICE PREDICTION/ridgeregression3.png")
```
Source: *The Elements of Statistical Learning* by Robert Hastie, Trevor Tibshirani and Jerome Friedman
...
```{r, warning = FALSE, message = FALSE, fig.align="center", echo = FALSE, fig.height = 5, fig.width = 10}
include_graphics("C:/Users/marct/OneDrive - Tecnocampus Mataro-Maresme/Documentos/CURSOS/PROJECTES/AIRBNB PRICE PREDICTION/lasso.png")
```
Source: *The Elements of Statistical Learning* by Robert Hastie, Trevor Tibshirani and Jerome Friedman
...
```{r, warning = FALSE, message = FALSE, fig.align="center", echo = FALSE, fig.height = 5, fig.width = 10}
include_graphics("C:/Users/marct/OneDrive - Tecnocampus Mataro-Maresme/Documentos/CURSOS/PROJECTES/AIRBNB PRICE PREDICTION/bagging.png")
```
...
```{r, warning = FALSE, message = FALSE, fig.align="center", echo = FALSE, fig.height = 5, fig.width = 10}
include_graphics("C:/Users/marct/OneDrive - Tecnocampus Mataro-Maresme/Documentos/CURSOS/PROJECTES/AIRBNB PRICE PREDICTION/gradientboosting.png")
```
Source: *The Elements of Statistical Learning* by Robert Hastie, Trevor Tibshirani and Jerome Friedman
...
library(knitr)
include_graphics("C:/Users/marct/OneDrive - Tecnocampus Mataro-Maresme/Documentos/CURSOS/PROJECTES/AIRBNB PRICE PREDICTION/euleridentity.png")
```